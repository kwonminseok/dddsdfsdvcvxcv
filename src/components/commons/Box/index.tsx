import { ArrayInterpolation, CSSObject, Interpolation, useTheme } from "@emotion/react"
...
export interface BoxOwnProps extends BoxSystemProps, __ThemeUIComponentsInternalProps {
 ...
 */
export const __isBoxStyledSystemProp = (prop: string) => (boxSystemProps as readonly string[]).includes(prop)
