...
const MakerCard = forwardRef(
  ({ _id, banner, profileImage, name, description, totalSupports, totalSupporters }: MakerProps, ref) => {
    return (
              ...
              >
                ...
                <Flex sx={{ justifyContent: "flex-end", pt: 4 }}>
                  <Flex sx={{ alignItems: "center" }}>
                    <User2 size={16} />
                    <Box sx={{ fontSize: "16px", pl: 1, fontWeight: "medium" }}>{formatNumber(totalSupporters)}</Box>
                  </Flex>
                </Flex>
              </Flex>
            </Box>
